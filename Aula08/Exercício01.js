...
Tarefa: Na tag <script>, você deve:
...
<body>
  ...
  <script>
    ...
    const btnFavorito = document.getElementById("btn-favorite");
    const btnLimpar = document.getElementById("btn-limpar");

    btnLike.addEventListener("click", registrarLike);
    btnDislike.addEventListener("click", registrarDislike);
    btnFavorito.addEventListener("click", registrarFavorito);
